    ...
    return (
      ...
      <section id="skills" className="py-16 bg-black text-white">
        <div className="container mx-auto px-4">
          ...
          {/* Skills grid */}
          <div className="bg-gray-900 border border-hacker rounded-lg p-6">
              ...
              <div key={category} className="mb-6 last:mb-0">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                  {items.map((skill) => (
                    <div 
                      key={skill} 
                      className="bg-gray-800 border border-gray-700 hover:border-hacker p-3 rounded-md transition-colors duration-300"
                    >
